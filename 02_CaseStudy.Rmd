...
Rachel is a completely fictional character created for this book. She is a business analyst working in the healthcare industry. Over the next few chapters we will follow Rachel through the SPC process using her datasets (also fictional; the code used to create the datasets are available in the appendex).
...
{SKP: insert flow chart png / image}
...
# {SKP: put this code in the appendix}
